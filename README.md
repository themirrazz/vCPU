...
Yes! Please keep in mind as of version 0.0.2, there is no standardized way of setting a CPU id.
...
The latest version of this library is `vCPU 0.0.2 Stable Release`. A string will always be appended to the beginning of each file along with a copyright notice.
